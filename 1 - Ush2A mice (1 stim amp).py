# -*- coding: utf-8 -*-
"""
Created on Tue Sep 04 13:57:03 2018
...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 12 14:29:47 2017
...
# ----------------------------------------------------------------------------
animal = 14
directory = 'C:/Users/Admin/Desktop/Batch1/animal014/session001/data.h5'
...
# -----------------------------------------------------------------------------
print '-------------------------------------------------------------------'    
print 'Hits: ',len(hit_times),'/',len(stim_times)
print 'Catch:',len(catch_times),'/',len(catch_stim_times)
print '-------------------------------------------------------------------'
print 'Hit ratio: ',round(100*((len(hit_times)-0.)/len(stim_times)),2),'%'
print 'Catch ratio: ',round(100*((len(catch_times)-0.)/len(catch_stim_times)),2),'%'
print '-------------------------------------------------------------------'
print 'Mean hit latency:',np.mean(hit_latencies),'ms'
...
if save_PSTH == True:
    ...
    save_directory = 'C:/Users/Admin/Desktop/Ush2A Hits/%s' % (filename_PSTH) 
    with open(save_directory, 'wb') as f:
        pickle.dump(hit_latencies, f)
